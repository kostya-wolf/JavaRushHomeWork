...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament kvart: apartaments)
        {
            if (kvart instanceof Apt1Room) ((Apt1Room) kvart).clean1Room();
            else if (kvart instanceof Apt2Room) ((Apt2Room) kvart).clean2Rooms();
            else if (kvart instanceof Apt3Room) ((Apt3Room) kvart).clean3Rooms();
        }
    }
