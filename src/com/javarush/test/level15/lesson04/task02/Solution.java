...
public class Solution {
    ...
    public static void printMatrix(byte m, int n, String value) {
        System.out.println("byte m, int n");
        printMatrix(m, n, (Object) value);
    }
