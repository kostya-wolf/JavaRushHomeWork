...
public class Solution {
    ...
    public static class Clock extends Thread {
        ...
        private void printTime() throws InterruptedException {
            ...
            Date novTime = new Date();
            int y = novTime.getYear();
            int m = novTime.getMonth();
            int d = novTime.getDay();
            novTime = new Date(y, m, d, hours, minutes, seconds);
            novTime.setTime(novTime.getTime()+1000);
            sleep(1000);
            this.hours = novTime.getHours();
            this.minutes = novTime.getMinutes();
            this.seconds = novTime.getSeconds();
